...
#include "MW_I2C.h"
    ...
    #include "devices.h"
    // #include "I2C.h" 
    // Add I2C.h back after initialize/terminate functions are fixed in targetHardware.
    ...
    // Remove the following macros after adding I2C.h back.
    // I2C Error codes taken from raspi I/O server source (I2C.h)
    ...
    DEV_entry_t * EXT_I2C_initH(const unsigned int bus)
    {
        ...
        else
        {
            ...
            /* Raspi I/O throws error on creating a device object with same I2C address */
            ...
            perror("I2C_init/I2C_open Error");
            exit(-1);
        }
