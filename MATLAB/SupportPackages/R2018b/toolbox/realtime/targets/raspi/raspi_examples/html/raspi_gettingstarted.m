...
% with the support package. If you did not set up the hardware during
% support package installation, follow the instructions under the 'Hardware Setup' section of 
% <matlab:web('http://www.mathworks.com/help/supportpkg/raspberrypiio/ug/install-support-for-raspberry-pi-hardware.html','-browser')
% Install Support for Raspberry Pi Hardware> page to setup the hardware for
% use with MATLAB.
