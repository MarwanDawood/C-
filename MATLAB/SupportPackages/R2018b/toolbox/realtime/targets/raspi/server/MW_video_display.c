...
static void MW_drawYUV(int window, const Uint8 *yPtr, const Uint8 *uPtr, const Uint8 *vPtr)
{
	WindowInfo_t *currWindow = &(dispInfo.windowInfo[window]);
...
static void MW_drawRGB(int window, const Uint8 *rPtr, const Uint8 *gPtr, const Uint8 *bPtr)
{
	WindowInfo_t *currWindow = &(dispInfo.windowInfo[window]);
	Uint32 *imgPtr;
...
void MW_drawFrame(int window, const Uint8 *pln0, const Uint8 *pln1, const Uint8 *pln2)
{
    WindowInfo_t *currWindow = &(dispInfo.windowInfo[window]);
...
void MW_SDL_videoDisplayOutput(const Uint8 *pln0, const Uint8 *pln1, const Uint8 *pln2)
{
...
/* LocalWords:  tmp NOPARACHUTE uninitialize YUV YUYV
 */
