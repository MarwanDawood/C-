...
%% Prerequisites 
%
% Before you start with this example, we recommend you to complete the <raspberrypi_gettingstarted.html Getting Started with Raspberry Pi(R) Hardware> example. 
% 
%% Required Hardware
%
