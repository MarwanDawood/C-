...
%% Introduction
% 
% In this example you will learn how to create Simulink models that stream
...
%
% * Complete
% <raspberrypiiosgettingstarted.html LED Control from Apple iOS Device> example. 
...
% <raspberrypiiosgettingstarted.html LED Control from Apple(R) iOS(R) Device> example for setup steps.
%
